            ...
            <form action="/add/student" enctype="multipart/form-data" method="POST" class="flex flex-col">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <div class="label block text-gray-700 text-sm font-bold mb-2 ml-3">
                        ...
                        <input type="text" name="f_name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('f_name')}}>
                            @error('f_name')
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <div class="label block text-gray-700 text-sm font-bold mb-2 ml-3">
                        ...
                        <input type="text" name="l_name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('l_name')}}>
                            @error('l_name')
                                <p class="text-red-500 text-xs mt-2 p-1">
                                    {{$message}}
                                </p>
